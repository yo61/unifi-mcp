...
**Date:** 2026-07-05
**Status:** Parked (2026-09-24) — approved design, no implementation
...
> **Parked.** This design is approved but not scheduled. It is recorded here so
> the analysis survives; it is not a commitment to build. Issue #1 tracks the
> work and stays open. Nothing in the codebase implements this surface — the
> four existing tools serve the v1 Integration API only.
